...
var _user$project$Models_User$User = function (a) {
	return {login: a};
};

var _user$project$Routes$NotFound = {ctor: 'NotFound'};
var _user$project$Routes$Signup = {ctor: 'Signup'};
var _user$project$Routes$Login = {ctor: 'Login'};
var _user$project$Routes$Home = {ctor: 'Home'};

var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {mdl: a, token: b, user: c, route: d};
	});

var _user$project$Messages$ChangePage = function (a) {
	return {ctor: 'ChangePage', _0: a};
};
var _user$project$Messages$ErrorPage = {ctor: 'ErrorPage'};
var _user$project$Messages$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};

var _user$project$Router$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
		...
		_1: {
			...
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Routes$Login,
				_evancz$url_parser$UrlParser$s('login')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Routes$Signup,
					_evancz$url_parser$UrlParser$s('signup')),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Router$delta2url = F2(
		...
		return A2(
			...
			_elm_lang$core$Maybe$Just(
				A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$core$Basics$toString(current.route),
						_1: {ctor: '[]'}
					},
					_rgrempel$elm_route_url$RouteUrl_Builder$newEntry(_rgrempel$elm_route_url$RouteUrl_Builder$builder))));
	});
var _user$project$Router$parsePath = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Router$route, location);
	if (_p0.ctor === 'Nothing') {
...
var _user$project$Router$parseUrl = function (location) {
	var _p1 = A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Router$route, location);
	if (_p1.ctor === 'Nothing') {
		return {
			ctor: '::',
			_0: _user$project$Messages$ErrorPage,
			_1: {ctor: '[]'}
		};
	} else {
		return {
			ctor: '::',
			_0: _user$project$Messages$ChangePage(_p1._0),
			_1: {ctor: '[]'}
		};
	}
};
		...
		switch (_p0.ctor) {
			...
			case 'ErrorPage':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{route: _user$project$Routes$NotFound}),
					{ctor: '[]'});
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Evolution'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Layout$href('http://package.elm-lang.org/packages/debois/elm-mdl/latest/'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$Main$init = function (flags) {
	var route = _user$project$Routes$Login;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{token: flags.token, user: flags.user, mdl: _debois$elm_mdl$Material$model, route: route},
		{ctor: '[]'});
};
var _user$project$Main$main = _rgrempel$elm_route_url$RouteUrl$programWithFlags(
	{
		delta2url: _user$project$Router$delta2url,
		location2messages: _user$project$Router$parseUrl,
